...
func (pq *PermissionQuery) loadUsers(ctx context.Context, query *UserQuery, nodes []*Permission, init func(*Permission), assign func(*Permission, *User)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(permission.UsersTable)
		s.Join(joinT).On(s.C(user.FieldID), joinT.C(permission.UsersPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(permission.UsersPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(permission.UsersPrimaryKey[1]))
